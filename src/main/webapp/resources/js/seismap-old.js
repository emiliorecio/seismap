var seismap = {
  ...
  showGenericError : function() {
    seismap.showError('Ups! Hubo un error. Perd�n!');
  },
...
var basePage = {
  ...
  newCategory : function() {
    seismap.showPrompt('Ingrese el nombre para la nueva categor�a:',
        basePage.createCategory.bind(basePage), null, '', 'Nueva Categor�a',
        'Crear');
    return false;
  },
...
var mapPage = {
  ...
  registerControlHandles : function() {
    ...
    nameControl.addEvent('blur', function() {
      ...
      if (value == 0) {
        seismap.showAlertAndFocus('El nombre no puede estar vac�o.',
            nameControl);
      } else {
    ...
    centerLatitudeControl.addEvent('blur', function() {
      ...
      if (value == null || value < -90 || value > 90) {
        seismap.showAlertAndFocus('La latitude debe estar entre -90� y 90�',
    ...
    centerLongitudeControl.addEvent('blur', function() {
      ...
      if (value == null || value < -180 || value > 180) {
        seismap.showAlertAndFocus('La longitud debe estar entre -180� y 180�',
    ...
    minDateRelativeAmountControl.addEvent('blur', function() {
      ...
      if (value == null || value < 0) {
        seismap.showAlertAndFocus(
            'La fecha relativa m�nima debe ser mayor a cero',
    ...
    minDateControl.addEvent('blur', function() {
      ...
      if (value == null) {
        seismap.showAlertAndFocus('La fecha m�nima debe ser v�lida',
            minDateControl);
      } else {
    ...
    minTimeControl.addEvent('blur', function() {
      var value = seismap.parseDateTime(minDateControl.value,
          minTimeControl.value);
      if (value == null) {
        seismap.showAlertAndFocus('La hora m�nima debe ser v�lida',
            minTimeControl);
      } else {
        minDateControl.value = seismap.formatDate(value);
        minTimeControl.value = seismap.formatTime(value);
    ...
    maxDateRelativeAmountControl.addEvent('blur', function() {
      ...
      if (value == null || value < 0) {
        seismap.showAlertAndFocus(
            'La fecha relativa m�xima debe ser mayor a cero',
    ...
    maxDateControl.addEvent('blur', function() {
      ...
      if (value == null || value < 0) {
        seismap.showAlertAndFocus('La fecha m�xima debe ser v�lida',
            maxDateControl);
      } else {
    ...
    maxTimeControl.addEvent('blur', function() {
      var value = seismap.parseDateTime(maxDateControl.value,
          maxTimeControl.value);
      if (value == null || value < 0) {
        seismap.showAlertAndFocus('La hora m�xima debe ser v�lida',
            maxTimeControl);
      } else {
        maxDateControl.value = seismap.formatDate(value);
        maxTimeControl.value = seismap.formatTime(value);
    ...
    maxDepthControl.addEvent('blur', function() {
      ...
      if (value == null || value < 0) {
        seismap.showAlertAndFocus(
            'La profundidad m�xima debe ser mayor a cero', maxDepthControl);
      } else {
    ...
    minDepthControl.addEvent('blur', function() {
      ...
      if (value == null || value < 0) {
        seismap.showAlertAndFocus(
            'La profundidad m�nima debe ser mayor a cero', minDepthControl);
      } else {
    ...
    animationStepsControl.addEvent('blur', function() {
      ...
      if (value == null || value < 2) {
        seismap.showAlertAndFocus(
            'Los cantidad de cuadros de la animaci�n ser mayor o igual a 2',
        ...
        .addEvent(
            ...
            function() {
              ...
              if (value == null || value < 1) {
                seismap
                    .showAlertAndFocus(
                        'Los duraci�n de los cuadros de la animaci�n ser mayor o igual a 1',
                        animationStepDurationControl);
              } else {
        ...
        .addEvent(
            ...
            function() {
              ...
              if (value == null || value < 0 || value > 100) {
                seismap
                    .showAlertAndFocus(
                        'Los preservaci�n de los cuadros de la animaci�n ser estar entre 0% y 100%',
                        animationStepKeepControl);
              } else {
