...
function startibox() {
  init_ibox();
  showIbox("../html/start.html",{width:500, height:300})
  showBG();
}
...
createIbox = function(elem) {
  ...
  strHTML +=  "<div id='ibox_progress' style='display:none;'>Loading...</div>";
  strHTML +=  "<div id='ibox_wrapper' style='display:none'>";
  strHTML +=  "<div id='ibox_content'></div>";
  strHTML +=  "<div id='ibox_footer_wrapper'><div id='ibox_close' style='float:right;'>";
  strHTML +=  "<a style='font-size:12px;' id='ibox_close_a' href='javascript:void(null);'>Click here to close this window</a></div>";
...
showIbox = function(url,params) {
  ...
  switch(ibox_type) {
    ...
    case 2:
      ...
      else {ibox.style.height = '71%';}
      
      if(params['width']) {ibox.style.width = params['width']+'px';} 
      else {ibox.style.width = '71%';}
...
setIBoxHTML = function(url) {
    //var root = window.location.href + "html/";
    var root = "/html/";
    var http = createRequestObject();
    http.open('get', root + url, true);
    http.onreadystatechange = function() {
      if(http.readyState == 4){
        var response = http.responseText;
        setIBoxContent(response);
